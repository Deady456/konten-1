...
from . import script, voice, captions, visuals, science_visuals, assemble, assemble_vanta, upload, state, visuals_ai
...
def run_once(publish_at: str | None = None, upload_to_youtube: bool = True,
    ...
    # ============================================================
    # Step 4: Fetch science & space visuals (NASA + Wikimedia + FLUX)
    _log("4/8 Fetching science & space visuals")
    scene_videos = science_visuals.fetch_all(data["scenes"], work / "broll", words=words, voice_audio=voice_mp3)
